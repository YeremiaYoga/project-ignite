    ...
    <div className=" text-zinc-100 p-8 rounded-xl mx-auto shadow-lg">
      ...
      <CollapsibleSection title="Proficiencies">
        <ul className="list-disc list-inside text-zinc-300 space-y-2">
          ...
          <li>
            <span className="font-semibold text-zinc-100">Weapons:</span> Simple
            weapons
          </li>
          <li>
            <span className="font-semibold text-zinc-100">Tools:</span> Thieves'
            tools, tinker's tools, one type of artisan’s tools of your choice
          </li>
          <li>
            <span className="font-semibold text-zinc-100">Saving Throws:</span>{" "}
            Constitution, Intelligence
          </li>
          <li>
            <span className="font-semibold text-zinc-100">Skills:</span> Choose
      ...
      <CollapsibleSection title=" Magical Tinkering">
        <p className="text-zinc-300 mb-4 leading-relaxed text-base">
          ...
          mundane objects. To use this ability, you must have thieves’ tools or
          artisan’s tools in hand. You then touch a Tiny nonmagical object as an
          action and give it one of the following magical properties of your
          choice:
        </p>
        <ul className="list-disc list-inside text-zinc-300 space-y-2 text-base mb-6">
          ...
          <li>
            ...
            that can be heard up to 10 feet away. You utter the message when you
            bestow this property on the object, and the recording can be no more
            than 6 seconds long.
          </li>
          <li>
          ...
          <li>
            ...
            effect can be a picture, up to 25 words of text, lines and shapes,
      ...
      <CollapsibleSection title="Spellcasting">
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed text-base">
          You produce your artificer spell effects through your tools. You must
          have a spellcasting focus – specifically thieves’ tools or some kind
          of artisan’s tools – in hand when you cast any spell with the
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed text-base">
          At 1st level, you know two cantrips of your choice from the artificer
          spell list. At higher levels, you learn additional artificer cantrips
          of your choice, as shown in the Cantrips Known column of the Artificer
          table. When you gain a level in this class, you can replace one of the
          artificer cantrips you know with another cantrip from the artificer
          spell list.
        </p>
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed text-base">
          ...
          artificer spells. To cast one of your artificer spells of 1st level or
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed text-base">
          ...
          cast, choosing from the artificer spell list. When you do so, choose a
          number of artificer spells equal to your Intelligence modifier + half
          your artificer level, rounded down (minimum of one spell). The spells
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed text-base">
          ...
          of prepared spells can include four spells of 1st or 2nd level, in any
          combination. If you prepare the 1st-level spell <em>Cure Wounds</em>,
          you can cast it using a 1st-level or a 2nd-level slot. Casting the
        ...
        <p className="text-zinc-300 mb-6 leading-relaxed text-base">
          ...
          tinkering with your spellcasting focuses: at least 1 minute per spell
      ...
      <CollapsibleSection title="Infuse Item">
        ...
        <p className="text-zinc-300 mb-2 leading-relaxed text-base">
          ...
          item. It works only on certain kinds of objects, as specified in the
          infusion’s description. If the item requires attunement, you can
          attune yourself to it the instant you infuse it. If you decide to
          attune to the item later, you must do so using the normal process for
          attunement (see the attunement rules in the{" "}
        ...
        <p className="text-zinc-300 mb-2 leading-relaxed text-base">
          ...
          modifier (minimum of 1 day). The infusion also vanishes if you replace
        ...
        <p className="text-zinc-300 mb-2 leading-relaxed text-base">
          ...
          column of the Artificer table. You must touch each of the objects, and
            ...
            <tbody>
              <tr className="border-b border-zinc-700">
                ...
                <td className="py-2 px-4">
                  Tasha’s Cauldron of Everything / Eberron: Rising from the Last
                  War
                </td>
              </tr>
              <tr className="border-b border-zinc-700">
              ...
              <tr className="bg-zinc-800 text-zinc-400">
                <td className="py-2 px-4 bg-blue-900 text-blue-200" colSpan="2">
      ...
      <CollapsibleSection title="The Right Tool for the Job">
        <div>
          <p className="text-base">
            ...
            work, which can coincide with a short or long rest. Though the
            product of magic, the tools are nonmagical, and they vanish when you
      ...
      <CollapsibleSection title="Flash of Genius">
        <p className="text-base">
          ...
          feet of you makes an ability check or a saving throw, you can use your
          reaction to add your Intelligence modifier to the roll. You can use
          this feature a number of times equal to your Intelligence modifier
      ...
      <CollapsibleSection title="Spell-Storing Item">
        <p className="text-base">
          ...
          item that you can use as a spellcasting focus, and you store a spell
          in it, choosing a 1st- or 2nd-level spell from the artificer spell
          list that requires 1 action to cast (you don’t need it prepared).
        </p>
        <p className="text-base">
          While holding the object, a creature can use an action to produce the
