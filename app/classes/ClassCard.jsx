...
export default function ClassCard({ className, info }) {
  ...
  return (
    <div className=" shadow-md rounded overflow-hidden max-w-xs flex flex-col">
      <div className="relative h-75 bg-gray-300 rounded-xl">
        <Image
          src={`/assets/classIcon/${className}_icon.webp`}
          alt={`${capitalized} Art`}
          fill
          className="object-cover"
        />
        <div className="absolute top-4 left-4 bg-white bg-opacity-95 p-3 rounded-md shadow-md w-[75%] z-10 ">
          ...
          <p className="text-sm text-gray-500 italic mt-1">Player’s Handbook</p>
          <hr className="my-2 border-orange-400 w-1/2" />

          <p className="text-xs text-gray-700 mt-1">{info.description}</p>
