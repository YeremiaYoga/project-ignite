...
export default function RaceCard({ race }) {
  const { raceName, image, description, handbook, traits } = race;
    ...
    <div>
      <div className="rounded overflow-hidden flex flex-col w-44  sm:w-100 aspect-[3/2]">
        <div className="relative aspect-square bg-gray-700 rounded-xl">
          ...
          <div className="absolute top-2 left-2 sm:top-4 sm:left-4 bg-gray-800/80 p-2 sm:p-3 rounded-md shadow-md w-[66%] sm:w-[66%] z-10">
            <h2 className="text-xs sm:text-base font-bold">{capitalized}</h2>
            <p className="text-[10px] sm:text-sm text-gray-400 italic mt-1">
              {handbook || "Unknown Handbook"}
            </p>
